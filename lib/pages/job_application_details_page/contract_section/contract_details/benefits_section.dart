...
import 'package:manage_applications/pages/job_application_details_page/contract_section/contract_details/benefits_form.dart';
import 'package:manage_applications/pages/job_application_details_page/contract_section/contract_details/benefits_notifier.dart';
      ...
      child: Column(
        children: [
          ...
          SectionWidget(
            ...
            body: SizedBox(height: 280.0, child: _BenefitsList(routeArg)),
          ),
        ],
      ),
    );
...
class _BenefitsList extends ConsumerWidget {
    ...
    return benefitsAsync.when(
      ...
      data:
          (benefits) => ItemListWithActionsWidget(
            ...
            deleteCallback: (benefit) => _delete(ref, context, benefit.id!),
          ),
      error:
  ...
  Future<void> _delete(WidgetRef ref, BuildContext context, int id) async {
    final result = await ref
        .read(benefitsProvider(getRouteArg<int?>(context)).notifier)
        .deleteBenefit(id);
